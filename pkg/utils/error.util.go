...
func DatabaseError(ctx context.Context, logger log.Logger, err error) *common.Error {
...
func NotFoundError(ctx context.Context, logger log.Logger, err error) *common.Error {
	requestId := GetRequestIDFromOutgoingContext(ctx)
...
func RuntimeError(ctx context.Context, logger log.Logger, err error) *common.Error {
	requestId := GetRequestIDFromOutgoingContext(ctx)
...
func UnauthorizedError(ctx context.Context, logger log.Logger, err error) *common.Error {
	requestId := GetRequestIDFromOutgoingContext(ctx)
...
func PermissionDeniedError(ctx context.Context, logger log.Logger, err error) *common.Error {
	requestId := GetRequestIDFromOutgoingContext(ctx)
...
func InternalServerError(ctx context.Context, logger log.Logger, err error) *common.Error {
	requestId := GetRequestIDFromOutgoingContext(ctx)
...
func CustomError(ctx context.Context, logger log.Logger, code common.ErrorCode, errorCode int32, err error) *common.Error {
	requestId := GetRequestIDFromOutgoingContext(ctx)
